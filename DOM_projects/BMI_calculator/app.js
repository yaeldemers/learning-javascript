...
calculateBtn.addEventListener("click", (event) => {
    ...
    if (weight === "" || height ==="" || weight<=0 || height<=0) {
        return alert("Error, please enter proper height and weight.");
    }
    ...
    bmiResults.innerHTML = `<p id="bmi_result">BMI = <b>${Math.round(result*100)/100}</b> (<span 
        class="${msgColor}"><b>${bmiMsg}</b></span>)</p>`
